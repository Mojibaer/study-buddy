...
export function DocumentMetadata({ document }: DocumentMetadataProps) {
  const metadataItems: MetadataItem[] = [
    ...
    { icon: Calendar, label: 'Hochgeladen', value: document.created_at ? formatDate(document.created_at) : undefined },
    { icon: HardDrive, label: 'Dateigröße', value: document.file_size ? formatFileSize(document.file_size) : undefined },
  ]
